...
```bash
# Bitcoin RPC (for Sparrow remote)
...
│  ┌─────────────┐    ┌─────────────┐    ┌─────────────┐         │
│  │     Tor     │    │  Bitcoin    │    │     LND     │         │
│  │  172.28.0.2 │    │  Knots      │    │  172.28.0.4 │         │
│  │             │    │  172.28.0.3 │    │             │         │
│  │  SOCKS:9050 │◄───│             │◄───│  gRPC:10009 │         │
...
3. **Tor** provides hidden services for remote access
4. **Wallets** connect via RPC (local) or Tor (remote)
